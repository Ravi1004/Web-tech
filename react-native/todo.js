...
import { View, TextInput, Text, Button, ScrollView, StyleSheet, TouchableOpacity, }
from 'react-native';
        ...
        const tasks = this.props.tasks.map((task, i) => {
            return (
                <View>
                    <View>
                        <Text
                            style={{backgroundColor: task.complete ? 'green' : '',textDecorationStyle: 'solid',padding: 10,textAlign: 'center',color: "white"}}>
                            {task.name}
                        </Text>
